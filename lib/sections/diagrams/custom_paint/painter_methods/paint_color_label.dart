...
void paintColorLabel(Canvas canvas, Size size, {required Offset pos, String? text,
    Color color = Colors.green, double radius = 8, Offset? lineEndPoint}) {
  ...
  final paint = Paint()
    ...
    ..color = color;
  canvas.drawCircle(
      Offset(pos.dx * width, pos.dy * height), radius, paint);
  if (text != null) {
