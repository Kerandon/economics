...
//       if (d.key == IBSectionOld.intro) {
//         for (var e in d.value.entries) {
//           _notes[0].addAll({e.key: e.value});
//         }
//       } else if (d.key == IBSectionOld.micro) {
//         for (var e in d.value.entries) {
//           _notes[1].addAll({e.key: e.value});
//         }
//       } else if (d.key == IBSectionOld.macro) {
//         for (var e in d.value.entries) {
//           _notes[2].addAll({e.key: e.value});
//         }
//       } else if (d.key == IBSectionOld.global) {
//         for (var e in d.value.entries) {
...
//     }
//
//     for (var s in IBSectionOld.values) {
//       if (s == IBSectionOld.intro) {
