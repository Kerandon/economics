...
class WorldTradeQuotas extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paintAxis(size, canvas, 'Price of wine (\$)',
        'Quantity supplied of wine (\'000 bottles)');
    paintCurve(
      size,
      canvas,
    ...
    paintText(
      ...
      canvas,
      'quota',
      Offset(width * 0.32, height * 0.93),
    );
    paintArrow(size, canvas, Offset(width * 0.27, height * 0.85),
        oppositeArrowHead: true);
