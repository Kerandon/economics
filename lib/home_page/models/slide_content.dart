...
class SlideContent {
  ...
  factory SlideContent.key(String title, String content, {bool hl = false}) =>
      SlideContent(keyContent: KeyContent(title: title, content: content, hl: hl));

  factory SlideContent.term(String term, String explanation, {bool hl = false}) =>
      SlideContent(term: Term(term: term, explanation: explanation, hl: hl));
  ...
  factory SlideContent.alert(String text) =>
      SlideContent(alert: Alert(text));

  factory SlideContent.tip(String text) =>
      SlideContent(tip: Tip(text));

  // ========== COMBINATION HELPERS ==========
  factory SlideContent.textWithDiagram(String content, DiagramBundleEnum diagram, {bool hl = false}) =>
      SlideContent(
        content: Content(content, hl: hl),
        diagramBundleEnums: [diagram],
      );

  factory SlideContent.keyWithDiagram(String title, String content, DiagramBundleEnum diagram, {bool hl = false}) =>
      SlideContent(
        keyContent: KeyContent(title: title, content: content, hl: hl),
        diagramBundleEnums: [diagram],
      );

  factory SlideContent.termWithDiagram(String term, String explanation, DiagramBundleEnum diagram, {bool hl = false}) =>
      SlideContent(
        term: Term(term: term, explanation: explanation, hl: hl),
        diagramBundleEnums: [diagram],
      );

  factory SlideContent.termWithContent(String term, String explanation, String content, {bool hl = false}) =>
      SlideContent(
        term: Term(term: term, explanation: explanation, hl: hl),
        content: Content(content, hl: hl),
      );

  factory SlideContent.termWithKey(String term, String explanation, String keyTitle, String keyContent, {bool hl = false}) =>
      SlideContent(
        term: Term(term: term, explanation: explanation, hl: hl),
  ...
  factory SlideContent.textWithDiagrams(String content, List<DiagramBundleEnum> diagrams, {bool hl = false}) =>
      SlideContent(
        content: Content(content, hl: hl),
        diagramBundleEnums: diagrams,
      );

  factory SlideContent.termWithDiagrams(String term, String explanation, List<DiagramBundleEnum> diagrams, {bool hl = false}) =>
      SlideContent(
        term: Term(term: term, explanation: explanation, hl: hl),
        diagramBundleEnums: diagrams,
      );

  factory SlideContent.textWithAlert(String content, String alertText, {bool hl = false}) =>
      SlideContent(
        content: Content(content, hl: hl),
        alert: Alert(alertText),
      );

  factory SlideContent.textWithTip(String content, String tipText, {bool hl = false}) =>
      SlideContent(
        content: Content(content, hl: hl),
        tip: Tip(tipText),
      );
