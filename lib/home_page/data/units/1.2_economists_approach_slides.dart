...
Slide(
  ...
  contents: [
    ...
    SlideContent.term(
      'Theory',
      'is a generalized explanation of economic phenomena.',
    ),
    ...
    SlideContent.term(
      tag: Tag.supplement,
      'Ordinal Utility',
      'measures utility by ranking choices in terms of preferences. For example: Good B, Good A, Good C.',
    ),

    SlideContent.term(
      tag: Tag.supplement,
      'Cardinal Utility',
      'measures utility by the numerical value it provides. For example: Good A = 15 utils, Good B = 25 utils, Good C = 5 utils.',
    ),
    SlideContent.term(
      'Say\'s Law',
